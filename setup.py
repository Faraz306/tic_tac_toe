...
setup(
    name='yf_ttt',  #* Your package will have this name
    packages=['yf_ttt'],  #* Name the package again
    ...
    description='This package can be used to make tic tac toe app in 2 lines of code.',
    # Short description of your library
    author='Yamaan Faraz YF® official',  # Your name
    author_email='farazyamaan@gmail.com',  # Your email
    url='https://github.com/Faraz306/tic_tac_toe',  # Homepage of your library (e.g. github or your website)
    keywords=['tic tac toe', '2 lines tic tac toe', 'YF', "Yamaan Faraz YF® official package"],  # Keywords users can search on pypi.org
